...
export const useFiles = (projectId: Id<"projects"> | null) => {
    return useQuery(api.files.getFiles, projectId ? { projectId: projectId } : "skip");
}
    ...
    return useMutation(api.files.createFile)
        .withOptimisticUpdate((localStore, args) => {
            ...
            if (existingFiles !== undefined) {
                ...
                localStore.setQuery(api.files.getFolderContents, { projectId: args.projectId, parentId: args.parentId }, sortFiles([...existingFiles, newFile]))
            }
        })
}
...
export const useCreateFolder = () => {
    return useMutation(api.files.createFolder).withOptimisticUpdate((localStore, args) => {
        ...
        if (existingFiles !== undefined) {
            ...
            localStore.setQuery(api.files.getFolderContents, { projectId: args.projectId, parentId: args.parentId }, sortFiles([...existingFiles, newFolder]))
        }
    })
}
