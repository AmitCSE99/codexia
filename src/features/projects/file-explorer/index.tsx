...
export const FileExplorer = ({ projectId }: {
    ...
    return (
        <div className="h-full bg-sidebar">
            <ScrollArea>
                <div role="button" onClick={() => { setIsOpen((prev) => !prev) }} className="group/project cursor-pointer w-full text-left flex items-center gap-0.5 h-[22px] bg-accent font-bold">
