            ...
            <div className="flex-1 min-h-0 bg-background">
                {
                    !activeFile && (
                        <div className="size-full flex items-center justify-center">
                            <Image src="/logo.svg" alt="codexia" width={50} height={50} className="opacity-25" />
                        </div>
                    )
                }
                    ...
                    isActiveFileBinary && (
                        <div className="size-full flex items-center justify-center">
                            <div className="flex flex-col items-center gap-2.5 max-w-md text-center">
                                ...
                                <p className="text-sm">
                                    The file is not displayed in the text editor because either it is binary or uses an unsupported text encoding.
                                </p>
                            </div>
                        </div>
                    )
